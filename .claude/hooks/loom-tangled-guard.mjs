...
// mistake. Deny, and point back to the corpus. Packages without a corpus/ — the
// hand-written bootstrap, e.g. loom-lang — are left alone.
...
process.stdin.on('end', () => {
  try {
    ...
    if (/\/(node_modules|dist|out)\//.test(file)) return
